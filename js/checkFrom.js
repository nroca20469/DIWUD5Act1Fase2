...
function tryFormulario(e) {
    ...
    let cLongitudPass = comprovaLonguitud(password, 6, 25);  //True/False(longuitud de la contraseña)
...
userType.addEventListener('click', getUserType);  //Escoge el tipo de usuario
