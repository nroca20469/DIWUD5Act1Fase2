...
function comprovarUserLogIn(e) {
    ...
    if(comprovara >= 1) {  //Si hay algun usuario logeado, el formulario desaparecera y los botones se mostraran(go home && log out)
        botones.style.display = "block";
        formulario.style.display = "none";
    } else if(comprovara < 1 ){  //Lo contrario si no hay nadie logeado
